...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{out_3840x2160_t16_tile16_r1.png}}
...
% --- Inserted Figures ---
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.95\linewidth]{time_vs_threads_1920x1080.png}}
    \caption{Render Time vs Threads for 1920x1080 Resolution}
    \label{fig:time_threads}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.95\linewidth]{speedup_vs_threads_1920x1080.png}}
    \caption{Speedup vs Threads for 1920x1080 Resolution}
    \label{fig:speedup_threads}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.95\linewidth]{efficiency_vs_threads_1920x1080.png}}
    \caption{Parallel Efficiency vs Threads for 1920x1080 Resolution}
    \label{fig:efficiency_threads}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.95\linewidth]{cpu_avg_vs_threads_1920x1080.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{time_vs_threads_640x360.png}}
    \caption{Render Time vs Threads for 640x360 Resolution}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{time_vs_threads_1280x720.png}}
    \caption{Render Time vs Threads for 1280x720 Resolution}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{time_vs_threads_3840x2160.png}}
    \caption{Render Time vs Threads for 3840x2160 Resolution}
\end{figure}

% Speedup (All Resolutions)
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{speedup_vs_threads_640x360.png}}
    \caption{Speedup vs Threads for 640x360 Resolution}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{speedup_vs_threads_1280x720.png}}
    \caption{Speedup vs Threads for 1280x720 Resolution}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{speedup_vs_threads_3840x2160.png}}
    \caption{Speedup vs Threads for 3840x2160 Resolution}
\end{figure}

% Efficiency (All Resolutions)
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{efficiency_vs_threads_640x360.png}}
    \caption{Parallel Efficiency vs Threads for 640x360 Resolution}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{efficiency_vs_threads_1280x720.png}}
    \caption{Parallel Efficiency vs Threads for 1280x720 Resolution}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{efficiency_vs_threads_3840x2160.png}}
    \caption{Parallel Efficiency vs Threads for 3840x2160 Resolution}
\end{figure}

% CPU Avg and Max
\begin{figure}[htbp]
  \centerline{\includegraphics[width=0.9\linewidth]{cpu_grid_color.png}}
...
% Resolution Scaling
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.95\linewidth]{time_vs_resolution_threads16.png}}
    \caption{Render Time vs Resolution at 16 Threads}
    \label{fig:time_resolution}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{cpu_avg_vs_resolution_threads16.png}}
